(() => {
  // node_modules/.pnpm/@liveblocks+core@1.2.1/node_modules/@liveblocks/core/dist/index.mjs
    ...
    function getCachedToken(requestedScope, roomId) {
      ...
      for (let i = tokens.length - 1; i >= 0; i--) {
        ...
        if (token.parsed.k === "id") {
          return token;
        } else if (token.parsed.k === "sec-legacy") {
          return void 0;
...
${Array.from(traces).join("\n\n")}`
  ...
  // node_modules/.pnpm/@liveblocks+client@1.2.1/node_modules/@liveblocks/client/dist/index.mjs
  var PKG_NAME2 = "@liveblocks/client";
  var PKG_VERSION2 = "1.2.1";
  var PKG_FORMAT2 = "esm";
  detectDupes(PKG_NAME2, PKG_VERSION2, PKG_FORMAT2);

  // liveblocks/app.js
  var client = createClient({
    publicApiKey: "pk_prod_1ldya0i9DsODeO_tunLqa7zJRkEsLLYngizzm_2o_5VZIuhocIgX_B3zYU5DhWKY"
  });
